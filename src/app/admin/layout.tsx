...
const NAV_ITEMS = [
  { label: 'Inquiries', href: '/admin/inquiries', icon: 'M4 4h16v16H4zM4 6l8 6 8-6' },
  { label: 'Contact permissions', href: '/admin/contacts', icon: 'M4 4h16v16H4zM8 8h8M8 12h8M8 16h4' },
