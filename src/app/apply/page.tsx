          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
              ...
              <p className="text-gray-700 mb-8">
                Thanks for applying to join the Vicrez Installer Network! Our team will review your application and contact you using the details you provided.
              </p>
              <a 
                href="/"
      ...
      <main className="flex-1 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Join the Vicrez Installer Network</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  <label htmlFor="apply-business-name" className="block text-sm font-medium text-gray-700 mb-2">
                    Business Name *
                  </label>
                  <input id="apply-business-name"
                    type="text"
                    required
                ...
                <div className="md:col-span-2">
                  <label htmlFor="apply-street-address" className="block text-sm font-medium text-gray-700 mb-2">
                    Street Address
                  </label>
                  <input id="apply-street-address"
                    type="text"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-city" className="block text-sm font-medium text-gray-700 mb-2">
                    City *
                  </label>
                  <input id="apply-city"
                    type="text"
                ...
                <div>
                  <label htmlFor="apply-state" className="block text-sm font-medium text-gray-700 mb-2">
                    State *
                  </label>
                ...
                <div>
                  <label htmlFor="apply-zip-code" className="block text-sm font-medium text-gray-700 mb-2">
                    ZIP Code *
                  </label>
                  <input id="apply-zip-code"
                    type="text"
                    required
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                    value={formData.zip}
                ...
                <div>
                  <label htmlFor="apply-phone-number" className="block text-sm font-medium text-gray-700 mb-2">
                    Phone Number *
                  </label>
                  <input id="apply-phone-number"
                    type="tel"
                    required
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-email-address" className="block text-sm font-medium text-gray-700 mb-2">
                    Email Address *
                  </label>
                  <input id="apply-email-address"
                    type="email"
                    required
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
            ...
            {/* Web Presence */}
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Web Presence</h2>
              <p className="text-sm text-gray-400 mb-6">At least one is required</p>
              
              <div className="grid grid-cols-1 gap-6">
                <div>
                  <label htmlFor="apply-website" className="block text-sm font-medium text-gray-700 mb-2">
                    Website
                  </label>
                  <input id="apply-website"
                    type="url"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-instagram" className="block text-sm font-medium text-gray-700 mb-2">
                    Instagram
                  </label>
                  <input id="apply-instagram"
                    type="text"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-facebook" className="block text-sm font-medium text-gray-700 mb-2">
                    Facebook
                  </label>
                  <input id="apply-facebook"
                    type="text"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              {formData.services.includes('Other') && (
                <div className="mt-4">
                  <label htmlFor="apply-other-service-please-specify" className="block text-sm font-medium text-gray-700 mb-2">
                    Other Service (please specify)
                  </label>
                  <input id="apply-other-service-please-specify"
                    type="text"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="apply-years-in-business" className="block text-sm font-medium text-gray-700 mb-2">
                      Years in Business
                    </label>
                    <input id="apply-years-in-business"
                      type="number"
                      min="0"
                      className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                  ...
                  <div>
                    <label htmlFor="apply-how-did-you-hear-about-vicrez" className="block text-sm font-medium text-gray-700 mb-2">
                      How did you hear about Vicrez?
                    </label>
                    <select id="apply-how-did-you-hear-about-vicrez"
                      className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-google-business-url" className="block text-sm font-medium text-gray-700 mb-2">
                    Google Business URL
                  </label>
                  <input id="apply-google-business-url"
                    type="url"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-description-specialties" className="block text-sm font-medium text-gray-700 mb-2">
                    Description / Specialties
                  </label>
                  <textarea id="apply-description-specialties"
                    rows={4}
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
                ...
                <div>
                  <label htmlFor="apply-vehicle-brands-you-work-with" className="block text-sm font-medium text-gray-700 mb-2">
                    Vehicle Brands You Work With
                  </label>
                  <input id="apply-vehicle-brands-you-work-with"
                    type="text"
                    className="w-full px-4 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-vicrez-red focus:border-transparent"
