...
export const metadata: Metadata = {
  title:
    "Vicrez Installer Directory — All States | Body Kits, Wheels, Tires, Wrap & PPF",
  description:
    "Browse Vicrez installers by state. Find shops for body kits, OE bumpers, aero parts, wheels, tires, vinyl wrap, PPF, window tint, and exterior accessories. 6,000+ shops across all 50 states.",
  openGraph: {
    title: "Vicrez Installer Directory — All States",
    description:
      "Find trusted Vicrez installers in every state. Body kits, bumpers, wheels, tires, wrap, PPF & more. Browse recorded shop services nationwide.",
    type: "website",
...
export default async function DirectoryPage() {
  ...
  const totalInstallers = states.reduce(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-300 max-w-3xl leading-relaxed">
              Browse our nationwide directory of{" "}
              <strong>{totalInstallers.toLocaleString()} listed shops</strong>{" "}
              across every state. Find shops for OE replacement bumpers, body
              kits, widebody kits, front lips, side skirts, diffusers, spoilers,
              fender flares, aftermarket wheels, tires, wheel and tire packages,
              vinyl wrap, paint protection film (PPF), window tint, and exterior
              styling accessories. The Vicrez-recorded badge identifies a
              business source record; confirm current services and availability
              directly with each shop.
            </p>
          </div>
          ...
          >
            <p className="text-lg font-bold text-white">
              Shop Bumpers, Body Kits, Wheels, Tires, Wrap & PPF at Vicrez.com
            </p>
            <p className="text-sm text-white/80 mt-1">
              OE replacement parts, widebody kits, aero upgrades, aftermarket
              wheels, VCORSA tires, vinyl wrap, PPF & more — shipped nationwide
            </p>
          </a>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {states
                ...
                .sort((a: any, b: any) =>
                  (STATE_NAMES[a.state?.toUpperCase()] || "").localeCompare(
                    STATE_NAMES[b.state?.toUpperCase()] || "",
                  ),
                )
                .map((s: any) => {
                  ...
                  return (
                    ...
                    >
                      <span className="font-medium text-white group-hover:text-vicrez-red transition-colors">
                        {name}
                      </span>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
              ...
              <li>
                <a
                  ...
                  className="text-vicrez-red hover:underline"
                >
                  Wheel & Tire Installation Guide: Everything You Need to Know
                  (2026)
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="/guides/ppf-installation-guide"
                  className="text-vicrez-red hover:underline"
                >
                  PPF Installation Guide: Cost, Process & How to Find an
                  Installer (2026)
                </a>
              </li>
              <li>
                <a
                  href="/guides/coilover-installation-guide"
                  className="text-vicrez-red hover:underline"
                >
                  Coilover Installation Guide: Cost, Process & What to Expect
                  (2026)
                </a>
              </li>
            </ul>
