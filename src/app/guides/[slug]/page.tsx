...
> = {
  ...Object.fromEntries(
    Object.entries(PLANNING_GUIDES).map(([slug, guide]) => [
      slug,
      {
        title: guide.title,
        ...
        component: () => <PlanningGuide slug={slug} />,
      },
    ]),
  ),
  "body-kit-installation-cost": {
    ...
    description:
      "Detailed breakdown of body kit installation costs by type. Widebody kits ($2,000–$5,000+), lip kits ($200–$800), bumper kits ($500–$1,500) and more. Get accurate pricing for your project.",
  ...
  "widebody-kit-installation-guide": {
    ...
    description:
      "Step-by-step guide to widebody kit installation. Learn about preparation, fitting, painting, and what to expect from start to finish. Expert tips from professional installers.",
  ...
  "how-to-choose-body-kit-installer": {
    ...
    description:
      "Learn how to find the right body kit installer. 7 essential factors including experience, portfolio, pricing, warranty, and more. Avoid costly mistakes with our expert guide.",
  ...
  "wheel-and-tire-installation-guide": {
    ...
    description:
      "Complete guide to aftermarket wheel and tire installation. Costs, fitment specs (bolt pattern, offset, hub bore), TPMS, staggered vs square setups, and how to find an installer near you.",
  ...
  "vinyl-wrap-cost-guide": {
    ...
    description:
      "Comprehensive vinyl wrap cost breakdown by type. Full vehicle wraps ($2,500-$7,000), partial wraps, material costs, DIY vs professional installation, and how to choose a wrap shop.",
    datePublished: "2026-01-15",
  ...
  "ppf-installation-guide": {
    ...
    description:
      "Complete paint protection film guide. Partial front ($1,500-$3,000) vs full vehicle coverage, installation process, material quality, and choosing certified PPF installers.",
    datePublished: "2026-01-20",
    dateModified: "2026-04-04",
  ...
  "coilover-installation-guide": {
    ...
    description:
      "Comprehensive coilover installation guide. Installation costs ($550-$1,800), process overview, alignment requirements, DIY vs professional installation, and finding suspension specialists.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Breadcrumbs
            items={[
              ...
              {
                name: guide.title.split(":")[0].split("(")[0].trim(),
          ...
          <section className="mt-12 bg-gradient-to-r from-vicrez-red to-red-700 rounded-xl p-8 text-center">
            ...
            <p className="text-white/90 mb-6 max-w-xl mx-auto">
              Browse recorded services in our installer directory. Contact a
              suitable shop to confirm your vehicle, parts and installation
              needs.
            </p>
              ...
              {Object.entries(GUIDES)
                ...
                .map(([slug, g]) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-vicrez-muted mt-2 line-clamp-2">
                      {g.description}
                    </p>
                  </a>
                ))}
