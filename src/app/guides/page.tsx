...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Expert guides on body kit installation, wheel & tire installation, and choosing the right installer.",
    type: "website",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-300 max-w-2xl leading-relaxed">
              Everything you need to know about body kit, suspension, vinyl
              wrap, PPF, and wheel installation. From understanding costs to
              choosing the right installer, our expert guides help you make
              informed decisions for your build.
            </p>
          </div>
          ...
          <section className="mt-10 bg-vicrez-card border border-vicrez-border rounded-xl p-6">
            ...
            <a
              href="/directory"
              className="text-vicrez-red hover:underline text-sm font-medium"
            >
