...
export default async function InstallerPage({
  ...
  const correctionSubject = encodeURIComponent(
    `Directory correction: ${installer.business_name} (${params.slug})`,
  );

  const stateSlug = toStateSlug(installer.state);
  const citySlug = toLocationSlug(installer.city, installer.state);
  const stateName =
    STATE_NAMES[installer.state?.toUpperCase()] || installer.state;
      ...
      <main data-installer-id={installer.id} className="flex-1">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="flex items-center gap-3 mb-2">
                  {isVerified ? (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-green-500/10 text-green-400 border border-green-500/20">
                      ...
                      >
                        <path
                          d="M12 1L14.7 3.3H18.4L19 7L22 9.5L20.7 13L22 16.5L19 19L18.4 22.7H14.7L12 25L9.3 22.7H5.6L5 19L2 16.5L3.3 13L2 9.5L5 7L5.6 3.3H9.3L12 1Z"
                          fill="#1DA1F2"
                        ...
                        <path
                          ...
                          fill="white"
                          transform="scale(0.7) translate(5, 4.5)"
                        />
                      </svg>
                ...
                {rating && (
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm text-vicrez-muted">
                      Recorded Google rating
                    </span>
                    {reviewCount && (
                      <span className="text-vicrez-muted">
              ...
              <div className="card p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <svg
                    className="w-5 h-5 text-vicrez-muted mt-0.5 flex-shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                {phone && (
                  <div className="flex items-center gap-3">
                    <svg
                      className="w-5 h-5 text-vicrez-muted flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <a
                      href={`tel:${phone}`}
                      className="text-vicrez-red hover:underline text-lg"
                    >
                      {formatPhone(phone)}
                    </a>
                  </div>
                ...
                {publicContactEmail(installer) && (
                  <div className="flex items-center gap-3">
                    ...
                    <a
                      href={`mailto:${publicContactEmail(installer)}`}
              ...
              {quoteNote && (
                ...
                >
                  ...
                  <p className="text-sm text-vicrez-muted mb-3">
                    Services and specialties shown here come from this
                    shop&apos;s existing dealer-form record. They are not an
                    independent assessment of workmanship. Confirm current
                    services, availability, pricing and warranty terms directly
                    with the shop.
                  </p>
                  {profileGuide && (
                    <a
                      href={profileGuide.href}
                      className="text-vicrez-red hover:underline"
                    >
                      {profileGuide.label} →
                    </a>
              ...
              <section
                className="card p-6"
                aria-labelledby="listing-corrections"
              >
                <h2
                  id="listing-corrections"
                  className="text-lg font-semibold text-white mb-3"
                >
                  Own this shop or spot an error?
                </h2>
                <p className="text-gray-300 mb-3">
                  For corrections or removal, include this profile&apos;s URL,
                  the information to change and your relationship to the
                  business. Do not send passwords or payment information.
                </p>
                <a
                  href={`mailto:support@vicrez.com?subject=${correctionSubject}`}
                  className="text-vicrez-red hover:underline"
                >
                  Contact Vicrez about this listing
                </a>
                <p className="mt-2">
                  <a
                    href="/contact"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <OwnerDetails
            ...
            confirmed={
              installer.owner_details_confirmed_at
                ? String(installer.owner_details_confirmed_at)
                : null
            }
          />
        </div>
