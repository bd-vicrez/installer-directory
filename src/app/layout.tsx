...
export const metadata: Metadata = {
  title:
    "Vicrez Installer Network | Find Body Kit, Wheel, Tire & Wrap Installers Near You",
  description:
  ...
  openGraph: {
    title:
      "Vicrez Installer Network | Find Body Kit, Wheel, Tire & Wrap Installers Near You",
    description:
      "Find local shops for Vicrez body kits, bumpers, wheels, tires, vinyl wrap, PPF, and aftermarket parts. Browse recorded shop services nationwide.",
    type: "website",
