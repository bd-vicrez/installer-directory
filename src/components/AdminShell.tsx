...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: "M4 4h16v16H4zM4 6l8 6 8-6",
  },
  {
...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`hidden lg:flex fixed lg:sticky top-0 left-0 z-50 h-screen w-64 bg-gray-900 border-r border-gray-800 flex flex-col transition-transform duration-200 lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="p-5 border-b border-gray-800">
          <Link href="/admin" className="flex items-center gap-2">
            <div
              className="w-8 h-8 bg-vicrez-red rounded-lg flex items-center justify-center"
              style={{ color: "#fff" }}
            >
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span style={isActive ? {} : { color: "inherit" }}>
                  {item.label}
                </span>
              </Link>
            );
